...
<div class="single_page">
	...
	<div class="single_page_content"> <img class="img-center" src="{{asset('image/front/single_post_img.jpg')}}" alt="">
	...
	<div class="related_post">
		...
		<ul class="spost_nav wow fadeInDown animated">
			<li>
				<div class="media"> <a class="media-left" href="single_page.html"> <img src="{{asset('image/front/post_img1.jpg')}}" alt=""> </a>
					<div class="media-body"> <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a> </div>
				</div>
			</li>
			<li>
				<div class="media"> <a class="media-left" href="single_page.html"> <img src="{{asset('image/front/post_img2.jpg')}}" alt=""> </a>
					<div class="media-body"> <a class="catg_title" href="single_page.html"> Aliquam malesuada diam eget turpis varius</a> </div>
				</div>
			</li>
			<li>
