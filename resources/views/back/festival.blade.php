...
<div class="row">
	<div class="col-sm-12 col-md-6">
		<form action="/create_festival" method="Post" enctype="multipart/form-data">
			@csrf
			...
			{{-- festival --}}
			<div class="form-group">
				<input name="festival_text"class="form-control inputbox_color" type="text" placeholder="festival here..."data-toggle="tooltip" data-placement="left" title="Type festival">
			</div>
			{{-- img --}}
			<div class="form-group">
				<input type="file" accept="image/*" onchange="loadFile(event)" name="festival_img"class="form-control inputbox_color" placeholder="visa img...">
				<img id="output"/>
			</div>
			{{-- url --}}
			<div class="form-group">
		...
		{{-- Edit post --}}
		<form action="@if(isset($edit_festival->id))? route('/update_festival',['id'=>$edit_festival->id])@endif" method="POST" enctype="multipart/form-data">
			@csrf
			...
			{{-- festival --}}
			<div class="form-group">
				<input name="festival_text"id="festival_edit_text"class="form-control inputbox_color" type="text" placeholder="festival here..."data-toggle="tooltip" data-placement="left" title="Type festival">
			</div>
			{{-- img --}}
			<div class="form-group">
				<input type="file" accept="image/*" onchange="loadFiles(event)" name="festival_img"class="form-control inputbox_color" placeholder="visa img...">
				<img id="outputs"/>
			</div>
			{{-- url --}}
			<div class="form-group">
	...
	<div class="col-sm-12 col-md-6">
		<label class=" font-weight-bold text-white form-control bg-success text-center"><span id="show_festival">Show News</span> </label>
