					...
					<div class="container pd-0">
						<div class="row">
							<div class="col-md-8 col-sm-12">
								<div class="blog-list">
									<ul>@foreach($listed_travel as $listed)
										<li>
											<div class="row no-gutters">
												<div class="col-lg-4 col-md-12 col-sm-12">
													<div class="blog-img">
														<img src="{{asset('image/admin/travel/'.$listed->travel_img)}}" alt="" class="bg_img">
													</div>
												</div>
												<div class="col-lg-8 col-md-12 col-sm-12">
													<div class="blog-caption">
														<h4><a href="#">{{$listed->travel_title}}</a></h4>
														<div class="blog-by">
															<p>{!!$listed->travel_text!!}</p>
															<div class="pt-10">
													...
													<div class=" form-control hover_menu badge-light">
														<a class="pr-1 cursor_tag" href="{{ route('/edit_travel',['id'=>$listed->id]) }}"><i class="icon-copy fa fa-edit text-success" aria-hidden="true"></i></a>
														<a class="pr-1 cursor_tag" href="{{ route('/delete_travel',['id'=>$listed->id]) }}"><i class="icon-copy fa fa-trash text-danger" aria-hidden="true"></i></a>
							...
							<div class="col-md-4 col-sm-12">
								<div class="card-box mb-30">
									...
									<div class="list-group">
										<a href="#" class="list-group-item d-flex align-items-center justify-content-between">Post travel Deleted <span class="badge badge-primary badge-pill">{{$listed_travel_count}}</span></a>
